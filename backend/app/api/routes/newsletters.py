...
# NOTE: Newsletter cleanup has been removed in favor of article-based cleanup.
# Newsletters are now primarily for admin/debugging purposes.
# Articles are the primary user-facing entity and should be cleaned up instead.
